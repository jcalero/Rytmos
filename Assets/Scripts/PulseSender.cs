...
public class PulseSender : MonoBehaviour {
    ...
    void Update () 
    {
        // TODO: The method Input.GetMouseButton(_) is true if the button is being held and false otherwise,
        // so there's no need to check for that manually like you do here. /Jakob
